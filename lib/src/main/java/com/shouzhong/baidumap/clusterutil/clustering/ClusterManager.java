...
package com.shouzhong.baidumap.clusterutil.clustering;
...
import com.shouzhong.baidumap.clusterutil.clustering.algo.Algorithm;
import com.shouzhong.baidumap.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.shouzhong.baidumap.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.shouzhong.baidumap.clusterutil.clustering.view.ClusterRenderer;
import com.shouzhong.baidumap.clusterutil.clustering.view.DefaultClusterRenderer;
...
/**
 * Groups many items on activity map based on zoom level.
 * <p/>
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    /**
     * Force activity re-cluster. You may want to call this after adding new item(s).
     */
    public void cluster() {
    ...
    /**
     * Runs the clustering algorithm in activity background thread, then re-paints when results come back.
     */
    ...
    /**
     * Sets activity scanCallback that's invoked when activity Cluster is tapped. Note: For this listener to function,
     * the ClusterManager must be added as activity click listener to the map.
     */
    ...
    /**
     * Sets activity scanCallback that's invoked when activity Cluster is tapped. Note: For this listener to function,
     * the ClusterManager must be added as activity info window click listener to the map.
     */
    ...
    /**
     * Sets activity scanCallback that's invoked when an individual ClusterItem is tapped. Note: For this
     * listener to function, the ClusterManager must be added as activity click listener to the map.
     */
    ...
    /**
     * Sets activity scanCallback that's invoked when an individual ClusterItem's Info Window is tapped. Note: For this
     * listener to function, the ClusterManager must be added as activity info window click listener to the map.
     */
    ...
    /**
     * Called when activity Cluster is clicked.
     */
    ...
    /**
     * Called when activity Cluster's Info Window is clicked.
     */
