...
package com.shouzhong.baidumap.clusterutil.quadtree;
...
/**
 * A quad tree which tracks items with activity Point geometry.
...
public class PointQuadTree<T extends PointQuadTree.Item> {
    ...
    /**
     * Maximum number of elements to store in activity quad before splitting.
     */
    ...
    /**
     * Creates activity new quad tree with specified bounds.
     *
     * @param minX
     * @param maxX
     * @param minY
    ...
    /**
     * Search for all items within activity given bounds.
     */
