...
import com.shouzhong.baidumap.clusterutil.projection.Bounds;
...
import com.shouzhong.baidumap.clusterutil.quadtree.PointQuadTree;
 ...
 * 1. Iterate over items in the OrderBean they were added (candidate clusters).<br>
 * 2. Create activity cluster with the center of the item. <br>
 * 3. Add all items that are within activity certain distance to the cluster. <br>
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    private Bounds createBoundsFromSpan(Point p, double span) {
        // TODO: Use activity span that takes into account the visual size of the marker, not just its
        // LatLng.
