...
package com.shouzhong.baidumap.clusterutil.clustering.view;
...
import com.shouzhong.baidumap.R;
import com.shouzhong.baidumap.clusterutil.MarkerManager;
...
import com.shouzhong.baidumap.clusterutil.clustering.ClusterManager;
import com.shouzhong.baidumap.clusterutil.projection.Point;
import com.shouzhong.baidumap.clusterutil.projection.SphericalMercatorProjection;
import com.shouzhong.baidumap.clusterutil.ui.IconGenerator;
import com.shouzhong.baidumap.clusterutil.ui.SquareTextView;
...
import static com.shouzhong.baidumap.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;


/**
 * The default view for activity ClusterManager. Markers are animated in and out of clusters.
 */
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    /**
     * Gets the "bucket" for activity particular cluster. By default, uses the number of points within the
    ...
    /**
     * ViewModifier ensures only one re-rendering of the view occurs at activity time, and schedules
    ...
    private class ViewModifier extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mViewModificationInProgress) {
                // Busy - wait for the scanCallback.
                return;
            }
    ...
    /**
     * Determine whether the cluster should be rendered as individual markers or activity cluster.
     */
    ...
    /**
     * Transforms the current view (represented by DefaultClusterRenderer.mClusters and DefaultClusterRenderer.mZoom) to activity
     ...
     * be executed by activity MarkerModifier.
     * <p/>
    ...
    private class RenderTask implements Runnable {
        ...
        /**
         * A scanCallback to be run when all work has been completed.
         *
         * @param callback
         */
        ...
        public void run() {
            ...
            // activity hit in the MarkerCache.
     ...
     * animating activity markerWithPosition) is performed while trying not to block the rest of the app's
     * UI.
     */
    @SuppressLint("HandlerLeak")
    private class MarkerModifier extends Handler implements MessageQueue.IdleHandler {
        ...
        /**
         * Creates markers for activity cluster some time in the future.
         *
        ...
        /**
         * Removes activity markerWithPosition some time in the future.
         *
         * @param priority whether this operation should have priority.
        ...
        /**
         * Animates activity markerWithPosition some time in the future.
         *
        ...
        /**
         * Animates activity markerWithPosition some time in the future, and removes it when the animation
         * is complete.
         *
         * @param marker the markerWithPosition to animate.
         * @param from   the position to animate from.
    ...
    /**
     * Called before the marker for activity ClusterItem is added to the map.
     */
    protected void onBeforeClusterItemRendered(T item, MarkerOptions markerOptions) {
    }

    /**
     * Called before the marker for activity Cluster is added to the map.
     * The default implementation draws activity circle with activity rough count of the number of items.
     */
    ...
    /**
     * Called after the marker for activity Cluster has been added to the map.
     */
    protected void onClusterRendered(Cluster<T> cluster, Marker marker) {
    }

    /**
     * Called after the marker for activity ClusterItem has been added to the map.
     */
    protected void onClusterItemRendered(T clusterItem, Marker marker) {
    }

    /**
     * Get the marker from activity ClusterItem
     *
     * @param clusterItem ClusterItem which you will obtain its marker
     * @return activity marker from activity ClusterItem or null if it does not exists
     */
    ...
    /**
     * Get the marker from activity Cluster
     *
     * @param cluster which you will obtain its marker
     * @return activity marker from activity cluster or null if it does not exists
     */
    ...
    /**
     * Get the ClusterItem from activity marker
     *
     * @param marker which you will obtain its ClusterItem
     * @return activity ClusterItem from activity marker or null if it does not exists
     */
    ...
    /**
     * Get the Cluster from activity marker
     *
     * @param marker which you will obtain its Cluster
     * @return activity Cluster from activity marker or null if it does not exists
     */
    ...
    /**
     * Creates markerWithPosition(s) for activity particular cluster, animating it if necessary.
     */
    private class CreateMarkerTask {
         ...
         * @param markersAdded activity collection of markers to append any created markers.
    ...
    /**
     * Animates activity markerWithPosition from one position to another. TODO: improve performance for
