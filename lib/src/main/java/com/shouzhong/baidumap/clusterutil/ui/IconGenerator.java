 ...
 * window-like shape.
 * <p/>
 * The icon {@link Bitmap}s generated by the factory should be used in conjunction with activity {@link
...
public class IconGenerator {
    ...
    /**
     * Creates activity new IconGenerator with the default style.
     */
     ...
     * <p/>
     * This method is useful if activity custom view has previously been set, or if text content is not
     * applicable.
     */
     ...
     * <p/>
     * If the view contains activity {@link TextView} with the id "text", operations such as {@link
     ...
     *
     * @param degrees the amount the contents should be rotated, as activity multiple of 90 degrees.
     */
     ...
     * Rotates the icon.
     *
     * @param degrees the amount the icon should be rotated, as activity multiple of 90 degrees.
     */
    ...
    /**
     * Sets the style of the icon. The style consists of activity background and text appearance.
     */
    ...
    /**
     * Set the background to activity given Drawable, or remove the background.
     *
