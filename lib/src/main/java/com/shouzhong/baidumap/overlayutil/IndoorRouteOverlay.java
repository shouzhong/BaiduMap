 ...
 */
package com.shouzhong.baidumap.overlayutil;
...
public class IndoorRouteOverlay extends OverlayManager {
     ...
     */
    public IndoorRouteOverlay(BaiduMap baiduMap, int color1, int color2, int color3) {
        super(baiduMap);
        colorInfo = new int[] {color1, color2, color3};
    }
